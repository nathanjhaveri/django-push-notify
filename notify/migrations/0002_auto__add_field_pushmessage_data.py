...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PushMessage.data'
        db.add_column('notify_pushmessage', 'data',
                      self.gf('json_field.fields.JSONField')(default='null', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PushMessage.data'
        db.delete_column('notify_pushmessage', 'data')
